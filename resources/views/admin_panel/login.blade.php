...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index2.html" class="h1"><b>Admin Panel </b>Sitesi</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Lütfen giriş bilgilerinizi giriniz</p>
      <b style="color:red; font-weight:300px; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;"><?php if(isset($_GET['status']) && $_GET['status'] == "no"){ echo "Şifreniz veya e-posta adresiniz hatalı"; } ?></b>
      </br>
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button name="" type="submit" class="btn btn-primary btn-block">Giriş Yap</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
